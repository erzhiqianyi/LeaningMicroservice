...
@Data
@Table(name = WeixinAppPO.TABLE_NAME)
@Entity
public class WeixinAppPO {

    public static final String TABLE_NAME = "weixin_app";
    ...
    @Column(columnDefinition = "varchar(50) default not comment '账号类型，小程序，订阅号，服务号' ")
    private String appType;

    @Column(columnDefinition = "varchar(50) default not comment '账号认证状态，已认证，未认证' ")
    private String certifiedState;

    @Column(columnDefinition = "varchar(50) default not comment '账号主体类型' ")
